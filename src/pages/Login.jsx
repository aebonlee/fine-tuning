        ...
        <div className="auth-card">
          ...
          <div className="social-login-group">
            ...
            <button className="social-btn social-btn-kakao" onClick={signInWithKakao}>
              <i className="fa-solid fa-comment" aria-hidden="true" />{t('auth.kakao')}
            </button>
          </div>
          ...
          <form className="auth-form" onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <input id="login-email" className="form-input" type="email" placeholder={t('auth.email')} value={email} onChange={e => setEmail(e.target.value)} required autoComplete="email" />
            </div>
            <div className="form-group">
              <label htmlFor="login-password" className="sr-only">{t('auth.password')}</label>
              <input id="login-password" className="form-input" type="password" placeholder={t('auth.password')} value={password} onChange={e => setPassword(e.target.value)} required autoComplete="current-password" />
            </div>
            ...
            <button type="submit" className="auth-submit-btn" disabled={loading}>
              {loading ? <span className="loading-spinner" style={{ width: 20, height: 20, borderWidth: 2 }} /> : t('auth.loginBtn')}
            </button>
          </form>
